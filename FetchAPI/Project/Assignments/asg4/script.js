...
async function checkContent() {
    ...
    const endpoint = 'https://safetydemo.cognitiveservices.azure.com';
    const apiKey = 'EPaXpby9VcEuhcFJqktPtJGCMCekRzFwmHLvy29YsosUBcyo3mRFJQQJ99BDACYeBjFXJ3w3AAAHACOG3Ay8';
    ...
    try {
      ...
      if (Array.isArray(categoriesAnalysis)) {
        ...
        console.error("Unexpected data structure for categoriesAnalysis:", categoriesAnalysis);
      }

...
console.log(myBooks instanceof Array);
console.log(myBooks);
...
// // JSON.stringify - collection(e.g., array) input
console.log("\n--------");
...
console.log("\n--------");
console.log(parsed);
console.log(parsed instanceof Object);
...
console.log("Title of 1st book: " + parsed[0].title);
